...
Nolia is a macOS local-first Markdown knowledge workstation built with Electron, React, Vite, and TypeScript.
...
- App cannot open: check macOS security settings and package architecture.
