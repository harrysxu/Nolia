...
- [AI 文档入口](ai-assistant-runtime/README.md)：AI Assistant、Agent Runtime、权限、安全、当前实现和测试入口。
...
- [深度测试用例](ai-assistant-runtime/DEEP_AI_TEST_CASES.md)：AI Chat、语义索引、工作区操作、历史任务、权限边界和 Windows MCP 页面测试矩阵。
