...
- [Product and Technical Upgrade Plan](docs/product/PRODUCT_UPGRADE_PLAN.md)
- [Technical Upgrade Design](docs/architecture/TECHNICAL_UPGRADE_DESIGN.md)
- [UI/UX Upgrade Specification](docs/design/UI_UX_UPGRADE_SPEC.md)
